...
def YOLO_v3(width = 256,height = 256):
    '''
    Implementacja modelu autorstwa Matta Bast'a.
    Wprowadzono zmiany polegające na umieszczeniu dodatkowego parametru wysokości i szerokości obrazu wejściowego.
    wejscie: brak
    wyjscie: nieskompilowany graf modelu detekcyjnego YOLOv3
    '''
